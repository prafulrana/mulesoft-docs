...
Anypoint Visualizer integrates with Anypoint Monitoring to show metrics on top of the application network, which means that your account needs to have access to Anypoint Monitoring. Please contact your MuleSoft representative if this is not the case.
...
Monitoring Metrics are only supported for 3.9.1-AM and 4.1.2-AM Mule Runtime versions.

To select the AM versions, expand the "old patched releases" section in the runtime versions drop-down.
