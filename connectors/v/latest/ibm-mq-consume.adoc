...
to `MANUAL`. 
For more information regarding a Message ACK, see link:ibm-mq-ack[Handling Message Acknowledgment].
...
See link:ibm-mq-xml-ref[JMS Reference] for details regarding the attributes structure.
