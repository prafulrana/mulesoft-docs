...
This guide draws on information from the link:/mule-user-guide/v/3.9/windows-gateway-services-guide[Windows Gateway Services Guide] and assumes you are using Windows and Anypoint Studio. You can download the Windows version of Studio from the link:https://www.mulesoft.com/platform/studio[Anypoint Studio site].
...
. Download and install the Windows Gateway Services Software. A link to the software is in the link:/mule-user-guide/v/3.9/windows-gateway-services-guide[Windows Gateway Services Guide].
