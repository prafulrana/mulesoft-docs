= Reviewing OpenID Connect, OpenAM, or PingFederate OAuth Token Enforcement Policies concepts
...
* Your Anypoint Platform organization is setup as a link:/access-management/managing-api-clients[federated organization] using either OpenAM, OpenID Connect, or PingFederate.
+
