...
When this value is set, Gatekeeper security is set on in its maximum security level.
...
When this value is set, Gatekeeper security is set on in its intermediate security level.
