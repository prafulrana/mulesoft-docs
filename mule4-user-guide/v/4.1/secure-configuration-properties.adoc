...
1. Open your Mule project in Anypoint Studio. Go to the Mule Palette. 

2. Select _Search in Exchange_. Search for the _Mule Secure Configuration Property Extension_. 
