...
*Note:* Information on the September 2018 update to Exchange's use of REST Connect is available at https://docs.mulesoft.com/release-notes/anypoint-exchange-release-notes[Anypoint Exchange Release Notes].
