...
* *link:https://www.mulesoft.com/anypoint-pricing[Titanium Subscription Required]* - Instead of seeing links to API and Runtime alerts, you receive visual guidance showing how to open the configuration area for alerts in graphs for custom dashboards:
+
